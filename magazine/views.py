...
def _find_copy_links(book):
    ...
    if isbn:
        return [
            ...
            {"label": "Amazon",       "url": f"https://www.amazon.com/s?k={isbn}"},
            {"label": "eBay",         "url": f"https://www.ebay.com/sch/i.html?_nkw={isbn}"},
            {"label": "Bookshop.org", "url": f"https://bookshop.org/search?keywords={isbn}"},
            {"label": "Biblio",       "url": f"https://www.biblio.com/search.php?isbn={isbn}"},
        ...
        return [
            ...
            {"label": "Bookshop.org", "url": f"https://bookshop.org/search?keywords={q}"},
            {"label": "Biblio",       "url": f"https://www.biblio.com/search.php?title={title}&author={authors}"},
