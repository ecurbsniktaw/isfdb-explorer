...
def magazine_list(request):
    ...
    return render(request, "magazine/magazine_list.html", {
        ...
        "total_all":          django_settings.TOTAL_ALL,
        "total_issues":       django_settings.TOTAL_ISSUES,
        "query":              query,
...
def author_list(request):
    ...
    try:
        ...
        total_authors = django_settings.TOTAL_AUTHORS
...
def publisher_list(request):
    ...
    try:
        ...
        total_publishers = django_settings.PUBLISHER_COUNT
...
def about(request):
    # The following code, using stats, was replaced because it was
    # regenerating the statistics for the about page every time that
    # page was requested. But the stats never change (unless a new version
    # of the database is installed). The new code uses values set as the
    # dictionary ABOUT_STATS which is defined in settings.py. The values
    # for ABOUT_STATS are generated by mycode/genstats.py.
    #
    # cursor = _dict_cursor()
    # try:
